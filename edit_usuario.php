	...
	<div class="container">
		<div class="card card-container">
			...
			<form method="POST" action="proc_edit_usuario.php">
				...
				<input type="text" name="nome" placeholder="Digite o nome completo" value="<?php echo $row_usuario['nome']; ?>" required><br><br>
				<input type="text" type="login" name="login" placeholder="Digite o seu e-mail" value="<?php echo $row_usuario['login']; ?>" required><br><br>
				<input type="password" name="senha" placeholder="Digite a senha" value="<?php echo $row_usuario['senha']; ?>"  required><br><br>
				Permissões
				<select name="nivel">
